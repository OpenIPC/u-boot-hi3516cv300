...
void set_pcie_para_hi3536()
{
	unsigned int val;
	unsigned int flag;
	
	val = readl(REG_BASE_SCTL + REG_SYSSTAT);
	flag = (val >> 16) & 0x3;

	if (flag == 0x1) {
		val = readl(CRG_REG_BASE + REG_PERI_CRG43);
		val &= ~(0x1 << 12);
		writel(val, CRG_REG_BASE + REG_PERI_CRG43);

		val = readl(CRG_REG_BASE + REG_PERI_CRG44);
		val |= (0x1 << 7);
		writel(val, CRG_REG_BASE + REG_PERI_CRG44);

		writel(0x303, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x343, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x303, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x0, MIPS_REG_BASE + MISC_CTRL38);

		writel(0x90c, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x94c, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x90c, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x0, MIPS_REG_BASE + MISC_CTRL38);
	...
	if (flag == 0x3) {
		...
		writel(0x323, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x363, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x323, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x0, MIPS_REG_BASE + MISC_CTRL38);

		writel(0x92c, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x96c, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x92c, MIPS_REG_BASE + MISC_CTRL38);
		writel(0x0, MIPS_REG_BASE + MISC_CTRL38);
	}
}
